...
module.exports = (req, res) => {
    ...
    /* TODOS los .m3u8 pasan por el proxy.
       Razones:
       1. Links con query string: el proxy inyecta los params en cada segmento
       2. Links sin query string pero con segmentos relativos: el proxy
          construye las URLs absolutas correctas para cada segmento
       Los .mp4 van siempre directo — no necesitan proxy. */
